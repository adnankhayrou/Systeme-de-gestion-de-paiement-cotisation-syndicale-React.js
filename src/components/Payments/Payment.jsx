...
const Payment = () => {
  ...
  return (
    ...
    <SideBar/>
      ...
      <div className="sm:ml-64 sm:px-14 ps-3 my-3 sm:mt-14 print-only">
        <div className=" rounded-lg mb-3 me-3 pt-6">
          <div className='flex justify-end mt-5'>
            <button className="flex block text-white font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-pink-800 dark:hover:bg-pink-700 " type="button">
          ...
          <table className="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400">
            ...
            <tbody>
              ...
              <tr key={paidApartment._id} className="odd:bg-white odd:dark:bg-gray-900 even:bg-gray-50 even:dark:bg-gray-800 border-b dark:border-gray-700">
                ...
                <td className="px-9 py-4 ">
                <p className="font-medium p-1 pt-0 text-white rounded bg-green-700 text-center">
