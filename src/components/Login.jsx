          ...
          >
            ...
            <div className="inline-flex items-center">
              <p className="flex mt-3 items-center font-sans text-sm font-normal leading-normal text-gray-700 antialiased">
                <Link
                  className="font-medium text-pink-600 transition-colors hover:text-blue-700"
                  to="/forgotPassword"
                >
                  {" "}
                  Forgot Password?{" "}
            ...
            <p className="mt-4 block text-center font-sans text-base font-normal leading-relaxed text-gray-700 antialiased">
              ...
              <Link
                className="ms-2 font-medium text-pink-600 transition-colors hover:text-blue-700"
                to="/register"
              >
                Sign Up
              </Link>
