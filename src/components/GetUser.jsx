...
const GetUser = () => {
    ...
    const handleUser = (e) => {
        e.preventDefault();
            // navigate(`/showUser/${formData}`)
            navigate('/showUser', { state: { formData: formData }});
  ...
  return (
    ...
    <NavBar/>
    <div>
        <form className="mt-8 mb-2 w-80 max-w-screen-lg sm:w-96" onSubmit={handleUser}>
     ...
     {/* <div>the name of user is : {user}</div> */}
    </div>
    </>
  )
}
